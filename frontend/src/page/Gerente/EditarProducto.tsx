...
import { ActualizarProducto } from "../../types/personal";
...
export const GerenteEditarProducto = () => {
...
export const actionGerenteEditarProducto = async ({
  request,
  params,
}: ActionFunctionArgs) => {
  ...
  const producto: ActualizarProducto = {
    IdProducto: Number(params.IdProducto),
    Nombre,
